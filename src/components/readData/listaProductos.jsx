...
import ProductModal from "../modal/productos";
...
export const ListaProductos = () => {
  ...
  return (
    <div className="container mx-auto p-5">
      <h1 className="text-3xl primary-theme mb-6 text-center font-bold border-b-2 pb-2">Lista de Productos</h1>
        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="pr-4">
              ...
              <p className="text-theme">Precio: <span className="secondary-theme">Q{product.precio_unitario}</span></p>
              <p className="text-theme">Stock: <span className="secondary-theme">{product.stock}</span></p>
            </div>
          </div>
        ))}
      </div>
